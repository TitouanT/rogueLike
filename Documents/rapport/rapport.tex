...
ici mettre un petit mot
	...
	\section{Comment jouer ?}
		...
		\end{itemize}
		Ces commandes sont écrire dans le jeu en appuyant sur la touche <<?>>.
		Certains commandes sont encore à découvrir comme se déplacer en diagonale pour échapper à des monstres ou des codes de triches peuvent être utiliser grâce à la touche <<\_>>, pour les voir faîtes <<\_>> et taper <<help>> pour avoir la liste.
