...
Pour ce projet, nous avons dû nous organiser et trouver des outils afin de nous permettre de travailler à trois sur le code des uns des autres.
	...
	\section{Répartition des tâches}
		\begin{table}[!ht]
			...
			\begin{tabular}{|l|l|}
				\hline
				\multirow{2}{*}{Titouan} & Génération des niveaux \\
				& Monstres \\ \hline
				\multirow{2}{*}{Emeric} & Sauvegarde et changement de niveaux \\
				& Piège \\ \hline
				\multirow{3}{*}{Valentin} & Affichage \\
				& Interaction \\
				& Nourriture et vie \\  \hline
			\end{tabular}
...
\chapter{Résultat et conclusion}
	...
	<tout le monde>
	Le projet nous a permis d'apprendre à travailler en équipe et à nous échanger nos connaissances.
